...
-- -----------------------------------------------------
-- Table `laravel`.`task_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `laravel`.`task_detail` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_task_detail_task1_idx` (`task_id` ASC),
  CONSTRAINT `fk_task_detail_task1`
    FOREIGN KEY (`task_id`)
    REFERENCES `laravel`.`task` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
