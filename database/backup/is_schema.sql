...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `laravel`.`view_availableMaterial` (`id` INT, `material_no` INT, `brand` INT, `model` INT, `description` INT, `serial_no` INT, `warranty` INT, `amount` INT, `unit_price` INT, `create_user` INT, `create_date` INT, `update_user` INT, `update_date` INT, `stock_id` INT, `stock_name` INT);
