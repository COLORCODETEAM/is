	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">ระบบจัดการอุปกรณ์
					และห้องแลป</a>
			</div>
			<!-- /.navbar-header -->
					...
					<ul class="nav" id="side-menu">
						...
						<li><a href="{{ action('UserController@index')}}"><i
							...
							<ul class="nav nav-second-level">
								<li><a href="{{ action('UserController@viewStock')}}">จัดการคลัง</a></li>
								<li><a href="{{ action('UserController@viewMaterial')}}">จัดการวัสดุ</a></li>
								<li><a href="{{ action('UserController@viewDevice')}}">จัดการอุปกรณ์</a></li>
							</ul></li>
						<li><a href="{{ action('UserController@viewRoom')}}"><i class="fa fa-home fa-fw"></i>
								จัดการห้องแลป</a></li>
						<li><a href="{{ action('UserController@viewOrder') }}"><i class="fa fa-shopping-cart fa-fw"></i>
								สั่งซื้อวัสดุ-อุปกรณ์</a></li>
						<li><a href="{{ action('UserController@viewRoomBooking')}}"><i class="fa fa-calendar fa-fw"></i>
								จองห้องแลป และอุปกรณ์</a></li>
						<li><a href="{{ action('UserController@viewLend')}}"><i class="fa fa-edit fa-fw"></i>
								ยืม-คืนอุปกรณ์</a></li>
						<li><a href="{{ action('UserController@viewBring')}}"><i class="fa fa-list-alt fa-fw"></i>
								เบิก-จ่ายวัสดุ</a></li>
						<li><a href="{{ action('UserController@viewRepair')}}"><i class="fa fa-wrench fa-fw"></i>
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									...
									<div>รายการ ซื้อวัสดุ-อุปกรณ์!</div>
								</div>
							</div>
						</div>
						<a href="#">
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									...
									<div>รายการ แจ้งซ่อมอุปกรณ์!</div>
								</div>
							</div>
						</div>
						<a href="#">
