			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="{{ action('UserController@viewManageRoomBooking')}}"><i
								class="fa fa-calendar fa-fw"></i> จองห้องแลป และอุปกรณ์</a></li>
						<li><a href="{{ action('UserController@viewManageLend')}}"><i
								class="fa fa-edit fa-fw"></i> ยืม-คืนอุปกรณ์</a></li>
						<li><a href="{{ action('UserController@viewManageBring')}}"><i
								class="fa fa-list-alt fa-fw"></i> เบิก-จ่ายวัสดุ</a></li>
						<li><a href="{{ action('UserController@viewManageRepair')}}"><i
